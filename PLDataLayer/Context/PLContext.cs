...
using PLDataLayer.Entities.Gallery;
using PLDataLayer.Entities.Article;
using PLDataLayer.Entities.Sale;

namespace PLDataLayer.Context
{
    public class PLContext : DbContext
    {
        ...
        public string EncodePasswordtoMd5(string pass) //Encrypt using MD5   
        {
            Byte[] originalBytes;
            Byte[] encodedBytes;
            MD5 md5;
        ...
        public DbSet<PackInfo> PackInfos { get; set; }
        ...
        public DbSet<CourseTypeofMeasurment> CourseTypeofMeasurments { get; set; }

        #endregion
        #region Discounts
        public DbSet<SteppedDiscountType> SteppedDiscountTypes { get; set; }
        public DbSet<SteppedDiscount> SteppedDiscounts { get; set; }
        public DbSet<SteppedDiscountDetail> SteppedDiscountDetails { get; set; }
        public DbSet<StaticDiscount> StaticDiscounts { get; set; }
        public DbSet<CourseStaticDiscount> CourseStaticDiscounts { get; set; }
        public DbSet<UserRoleStaticDiscount> UserRoleStaticDiscounts { get; set; }
        #endregion
        #region Gallery
        ...
        public DbSet<TimelineComponent> TimelineComponents { get; set; }
        #endregion
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<About>()
               .HasQueryFilter(r => !r.IsDeleted);
            modelBuilder.Entity<TimelineComponent>()
               .HasQueryFilter(r => !r.IsDeleted);
            modelBuilder.Entity<Article>()
               .HasQueryFilter(r => !r.IsDeleted);
            modelBuilder.Entity<ArticleGroup>()
               .HasQueryFilter(r => !r.IsDeleted);
            modelBuilder.Entity<SiteFAQ>()
               .HasQueryFilter(r => !r.IsDeleted);
            ...
            modelBuilder.Entity<Role>().HasData(
                ...
                new Role { RoleId = 2, RoleTitle = "اپراتور", RoleName = "Operator" },
                new Role { RoleId = 3, RoleTitle = "مدرس", RoleName = "Teacher" },
                new Role { RoleId = 4, RoleTitle = "فراگیر", RoleName = "Student" }
            );
            #endregion
            #region Users
            string bd = "1356/06/31";
            DateTime dateTime = new DateTime(1977, 9, 22);
            modelBuilder.Entity<User>().HasData(
                new User
                {
                    ...
                    CountyId = 330,
                    UserSex = "مرد",
                    UserActiveCode = Guid.NewGuid().ToString().Replace("-", ""),
                    UserPassword = EncodePasswordtoMd5("0491579241"),
            ...
            modelBuilder.Entity<UserRole>().HasData(
               new UserRole { URId = 1, IsActive = true, RegisterDate = DateTime.Now, UserId = 1, RoleId = 1, UserRoleCode = 990 },
               new UserRole { URId = 2, IsActive = true, RegisterDate = DateTime.Now, UserId = 1, RoleId = 2, UserRoleCode = 991 },
               new UserRole { URId = 3, IsActive = true, RegisterDate = DateTime.Now, UserId = 1, RoleId = 3, UserRoleCode = 992 },
               new UserRole { URId = 4, IsActive = true, RegisterDate = DateTime.Now, UserId = 1, RoleId = 4, UserRoleCode = 993 }
               );
            #endregion
            #region UserLevel
            modelBuilder.Entity<UserLevel>().HasData(
                new UserLevel { UserLevel_Id = 1, UserLevel_Title = "متقاضی آزاد" },
                new UserLevel { UserLevel_Id = 2, UserLevel_Title = "بازاریاب" },
                new UserLevel { UserLevel_Id = 3, UserLevel_Title = "نماینده", UserLevel_HasUpload = true },
                new UserLevel { UserLevel_Id = 4, UserLevel_Title = "مشاور هادی", UserLevel_HasUpload = true },
                new UserLevel { UserLevel_Id = 5, UserLevel_Title = "مدیر فروش", UserLevel_HasUpload = true },
                new UserLevel { UserLevel_Id = 6, UserLevel_Title = "مدیر آموزش", UserLevel_HasUpload = true },
                new UserLevel { UserLevel_Id = 7, UserLevel_Title = "مدیر توسعه", UserLevel_HasUpload = true },
                new UserLevel { UserLevel_Id = 8, UserLevel_Title = "مدیر ارشد", UserLevel_HasUpload = true }
                );
            #endregion
            #region CourseLevel
            modelBuilder.Entity<CourseLevel>().HasData(
                new CourseLevel { CourseLevel_Id = 1, CourseLevel_Title = "مقدماتی" },
                new CourseLevel { CourseLevel_Id = 2, CourseLevel_Title = "متوسط" },
                new CourseLevel { CourseLevel_Id = 3, CourseLevel_Title = "پیشرفته" }
                );
            #endregion
            #region CourseStatus
            modelBuilder.Entity<CourseStatus>().HasData(
                new CourseStatus { CourseStatus_Id = 1, CourseStatus_Title = "حضوری" },
                new CourseStatus { CourseStatus_Id = 2, CourseStatus_Title = "غیر حضوری" },
                new CourseStatus { CourseStatus_Id = 3, CourseStatus_Title = "دانلودی" }
                );
            #endregion
            #region TypeofMeasurment
            modelBuilder.Entity<CourseTypeofMeasurment>().HasData(
                new CourseTypeofMeasurment { CTM_Id = 1, CTM_Title = "آزمون چهار گزینه ای" },
                new CourseTypeofMeasurment { CTM_Id = 2, CTM_Title = "آزمون تشریحی" },
                new CourseTypeofMeasurment { CTM_Id = 3, CTM_Title = "آزمون شفاهی" },
                new CourseTypeofMeasurment { CTM_Id = 4, CTM_Title = "آزمون عملی" },
                new CourseTypeofMeasurment { CTM_Id = 5, CTM_Title = "مصاحبه فنی" },
                new CourseTypeofMeasurment { CTM_Id = 6, CTM_Title = "بدون آزمون" }

                );
            #endregion
            #region Publisher
            modelBuilder.Entity<Publisher>().HasData(
                new Publisher { Publisher_Id = 1, Publisher_Title = "روابط عمومی" }
                );
            #endregion
            #region Permissions
            modelBuilder.Entity<Permission>().HasData(
               new Permission { PermissionId = 1, PermissionTitle = "مدیریت", ParentId = null },
               new Permission { PermissionId = 2, PermissionTitle = "مشاهده دوره ها", ParentId = null },
               new Permission { PermissionId = 3, PermissionTitle = "مشاهده فراگیران", ParentId = null },
               new Permission { PermissionId = 4, PermissionTitle = "مشاهده اساتید", ParentId = null },


               new Permission { PermissionId = 11, PermissionTitle = "کاربران", ParentId = 1 }, /*Sub Main*/
               new Permission { PermissionId = 12, PermissionTitle = "نقشها و دسترسی ها", ParentId = 1 },
               new Permission { PermissionId = 13, PermissionTitle = "گروه های آموزش", ParentId = 1 },
               new Permission { PermissionId = 14, PermissionTitle = "دوره های آموزش", ParentId = 1 },
               new Permission { PermissionId = 15, PermissionTitle = "اخبار", ParentId = 1 },
               new Permission { PermissionId = 16, PermissionTitle = "اسلایدر", ParentId = 1 },
               new Permission { PermissionId = 17, PermissionTitle = "جدول زمانی", ParentId = 1 },
               new Permission { PermissionId = 18, PermissionTitle = "صفحه درباره ما", ParentId = 1 },
               new Permission { PermissionId = 19, PermissionTitle = "اطلاعات تماس", ParentId = 1 },
               new Permission { PermissionId = 20, PermissionTitle = "اطلاعات کلی سایت", ParentId = 1 },
               new Permission { PermissionId = 21, PermissionTitle = "اینستاگرام", ParentId = 1 },
               new Permission { PermissionId = 22, PermissionTitle = "سوالات متداول", ParentId = 1 },
               new Permission { PermissionId = 23, PermissionTitle = "اطلاعات صفحات", ParentId = 1 },
               new Permission { PermissionId = 24, PermissionTitle = "اطلاعات پکیج ها", ParentId = 1 },
               new Permission { PermissionId = 25, PermissionTitle = "جداکننده ها", ParentId = 1 },
               new Permission { PermissionId = 26, PermissionTitle = "تخفیف ها", ParentId = 1 },


               new Permission { PermissionId = 51, PermissionTitle = "لیست کاربران", ParentId = 11 },/*Child*/
               new Permission { PermissionId = 52, PermissionTitle = "ویرایش کاربر", ParentId = 11 },

               new Permission { PermissionId = 53, PermissionTitle = "لیست نقشها", ParentId = 12 },
               new Permission { PermissionId = 54, PermissionTitle = "ایجاد نقش", ParentId = 12 },
               new Permission { PermissionId = 55, PermissionTitle = "ویرایش نقش", ParentId = 12 },
               new Permission { PermissionId = 56, PermissionTitle = "حــذف نقش", ParentId = 12 },
               new Permission { PermissionId = 57, PermissionTitle = "ویرایش نقش", ParentId = 12 },
               new Permission { PermissionId = 58, PermissionTitle = "مشاهده کاربران نقش", ParentId = 12 },
               new Permission { PermissionId = 59, PermissionTitle = "لیست دسترسی ها", ParentId = 12 },

               new Permission { PermissionId = 60, PermissionTitle = "لیست گروه ها", ParentId = 13 },
               new Permission { PermissionId = 61, PermissionTitle = "ایجاد گروه ", ParentId = 13 },
               new Permission { PermissionId = 62, PermissionTitle = "ویرایش گروه ", ParentId = 13 },
               new Permission { PermissionId = 63, PermissionTitle = "حذف گروه ", ParentId = 13 },

               new Permission { PermissionId = 64, PermissionTitle = "لیست دوره ها", ParentId = 14 },
               new Permission { PermissionId = 65, PermissionTitle = "ثبت دوره", ParentId = 14 },
               new Permission { PermissionId = 66, PermissionTitle = "ویرایش دوره", ParentId = 14 },
               new Permission { PermissionId = 67, PermissionTitle = "جزئیات دوره", ParentId = 14 },
               new Permission { PermissionId = 68, PermissionTitle = "حذف دوره", ParentId = 14 },
               new Permission { PermissionId = 69, PermissionTitle = "افزودن فایل", ParentId = 14 },
               new Permission { PermissionId = 70, PermissionTitle = "ویرایش فایل", ParentId = 14 },
               new Permission { PermissionId = 71, PermissionTitle = "حذف فایل", ParentId = 14 },
               new Permission { PermissionId = 72, PermissionTitle = "حذف فراگیر از دوره", ParentId = 14 },

               new Permission { PermissionId = 73, PermissionTitle = "لیست گروههای خبر", ParentId = 15 },
               new Permission { PermissionId = 74, PermissionTitle = "ثبت گروه خبر", ParentId = 15 },
               new Permission { PermissionId = 75, PermissionTitle = "ویرایش گروه خبر", ParentId = 15 },
               new Permission { PermissionId = 76, PermissionTitle = "حذف گروه خبر", ParentId = 15 },
               new Permission { PermissionId = 77, PermissionTitle = "لیست ناشران خبر", ParentId = 15 },
               new Permission { PermissionId = 78, PermissionTitle = "ثبت ناشر", ParentId = 15 },
               new Permission { PermissionId = 79, PermissionTitle = "ویرایش ناشر", ParentId = 15 },
               new Permission { PermissionId = 80, PermissionTitle = "حذف ناشر", ParentId = 15 },
               new Permission { PermissionId = 81, PermissionTitle = "لیست اخبار", ParentId = 15 },
               new Permission { PermissionId = 82, PermissionTitle = "ثبت خبر", ParentId = 15 },
               new Permission { PermissionId = 83, PermissionTitle = "ویرایش خبر", ParentId = 15 },
               new Permission { PermissionId = 84, PermissionTitle = "جزئیات خبر", ParentId = 15 },
               new Permission { PermissionId = 85, PermissionTitle = "حذف خبر", ParentId = 15 },
               new Permission { PermissionId = 86, PermissionTitle = "افزودن فایل", ParentId = 15 },
               new Permission { PermissionId = 87, PermissionTitle = "حذف فایل", ParentId = 15 },

               new Permission { PermissionId = 88, PermissionTitle = "لیست اسلایدرها", ParentId = 16 },
               new Permission { PermissionId = 89, PermissionTitle = "ثبت اسلایدر", ParentId = 16 },
               new Permission { PermissionId = 90, PermissionTitle = "ویرایش اسلایدر", ParentId = 16 },
               new Permission { PermissionId = 91, PermissionTitle = "جزئیات اسلایدر", ParentId = 16 },
               new Permission { PermissionId = 92, PermissionTitle = "حذف اسلایدر", ParentId = 16 },

               new Permission { PermissionId = 93, PermissionTitle = "لیست جدول", ParentId = 17 },
               new Permission { PermissionId = 94, PermissionTitle = "ثبت جدول", ParentId = 17 },
               new Permission { PermissionId = 95, PermissionTitle = "ویرایش جدول", ParentId = 17 },
               new Permission { PermissionId = 96, PermissionTitle = "جزئیات جدول", ParentId = 17 },
               new Permission { PermissionId = 97, PermissionTitle = "حذف جدول", ParentId = 17 },
               new Permission { PermissionId = 98, PermissionTitle = "لیست برنامه ها", ParentId = 17 },
               new Permission { PermissionId = 99, PermissionTitle = "ثبت برنامه", ParentId = 17 },
               new Permission { PermissionId = 100, PermissionTitle = "ویرایش برنامه", ParentId = 17 },
               new Permission { PermissionId = 101, PermissionTitle = "جزئیات برنامه", ParentId = 17 },
               new Permission { PermissionId = 102, PermissionTitle = "حذف برنامه", ParentId = 17 },

               new Permission { PermissionId = 103, PermissionTitle = "لیست", ParentId = 18 },
               new Permission { PermissionId = 104, PermissionTitle = "ثبت", ParentId = 18 },
               new Permission { PermissionId = 105, PermissionTitle = "ویرایش", ParentId = 18 },
               new Permission { PermissionId = 106, PermissionTitle = "جزئیات", ParentId = 18 },
               new Permission { PermissionId = 107, PermissionTitle = "حذف", ParentId = 18 },

               new Permission { PermissionId = 108, PermissionTitle = "لیست", ParentId = 19 },
               new Permission { PermissionId = 109, PermissionTitle = "ثبت", ParentId = 19 },
               new Permission { PermissionId = 110, PermissionTitle = "ویرایش", ParentId = 19 },
               new Permission { PermissionId = 111, PermissionTitle = "جزئیات", ParentId = 19 },
               new Permission { PermissionId = 112, PermissionTitle = "حذف", ParentId = 19 },

               new Permission { PermissionId = 113, PermissionTitle = "لیست", ParentId = 20 },
               new Permission { PermissionId = 114, PermissionTitle = "ثبت", ParentId = 20 },
               new Permission { PermissionId = 115, PermissionTitle = "ویرایش", ParentId = 20 },
               new Permission { PermissionId = 116, PermissionTitle = "جزئیات", ParentId = 20 },
               new Permission { PermissionId = 117, PermissionTitle = "حذف", ParentId = 20 },

               new Permission { PermissionId = 118, PermissionTitle = "لیست", ParentId = 21 },
               new Permission { PermissionId = 119, PermissionTitle = "ثبت", ParentId = 21 },
               new Permission { PermissionId = 120, PermissionTitle = "ویرایش", ParentId = 21 },
               new Permission { PermissionId = 121, PermissionTitle = "حذف", ParentId = 21 },

               new Permission { PermissionId = 122, PermissionTitle = "لیست", ParentId = 22 },
               new Permission { PermissionId = 123, PermissionTitle = "ثبت", ParentId = 22 },
               new Permission { PermissionId = 124, PermissionTitle = "ویرایش", ParentId = 22 },
               new Permission { PermissionId = 125, PermissionTitle = "جزئیات", ParentId = 22 },
               new Permission { PermissionId = 126, PermissionTitle = "حذف", ParentId = 22 },

               new Permission { PermissionId = 127, PermissionTitle = "لیست", ParentId = 23 },
               new Permission { PermissionId = 128, PermissionTitle = "ثبت", ParentId = 23 },
               new Permission { PermissionId = 129, PermissionTitle = "ویرایش", ParentId = 23 },

               new Permission { PermissionId = 130, PermissionTitle = "لیست", ParentId = 24 },
               new Permission { PermissionId = 131, PermissionTitle = "ثبت", ParentId = 24 },
               new Permission { PermissionId = 132, PermissionTitle = "ویرایش", ParentId = 24 },
               new Permission { PermissionId = 133, PermissionTitle = "حذف", ParentId = 24 },

               new Permission { PermissionId = 134, PermissionTitle = "لیست", ParentId = 25 },
               new Permission { PermissionId = 135, PermissionTitle = "ثبت", ParentId = 25 },
               new Permission { PermissionId = 136, PermissionTitle = "ویرایش", ParentId = 25 },
               new Permission { PermissionId = 137, PermissionTitle = "حذف", ParentId = 25 },

               new Permission { PermissionId = 138, PermissionTitle = "لیست انواع تخفیف پلکانی ", ParentId = 26 },
               new Permission { PermissionId = 139, PermissionTitle = "ثبت نوع تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 140, PermissionTitle = "ویرایش نوع تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 141, PermissionTitle = "حذف نوع تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 142, PermissionTitle = "ثبت نوع تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 143, PermissionTitle = "لیست تخفیفهای پلکانی", ParentId = 26 },
               new Permission { PermissionId = 144, PermissionTitle = "ثبت تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 145, PermissionTitle = "ویرایش تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 146, PermissionTitle = "جزئیات تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 147, PermissionTitle = "حذف تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 148, PermissionTitle = "لیست ردیفهای تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 149, PermissionTitle = "ثبت ردیف تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 150, PermissionTitle = "ویرایش ردیف تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 151, PermissionTitle = "جزئیات ردیف تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 152, PermissionTitle = "حذف ردیف تخفیف پلکانی", ParentId = 26 },
               new Permission { PermissionId = 153, PermissionTitle = "لیست تخفیفهای ثابت", ParentId = 26 },
               new Permission { PermissionId = 154, PermissionTitle = "ثبت تخفیف ثابت", ParentId = 26 },
               new Permission { PermissionId = 155, PermissionTitle = "ویرایش تخفیف ثابت", ParentId = 26 },
               new Permission { PermissionId = 156, PermissionTitle = "جزئیات تخفیف ثابت", ParentId = 26 },
               new Permission { PermissionId = 157, PermissionTitle = "فعال/غیرفعال کردن تخفیف ثابت", ParentId = 26 }
                );
            #endregion
            ...
            {
                modelBuilder.Entity<RolePermission>().HasData(
               new RolePermission { RP_Id = i - 6, RoleId = 1, PermissionId = i });
            }
            for (int i = 51; i <= 137; i++)
            {
                modelBuilder.Entity<RolePermission>().HasData(
               new RolePermission { RP_Id = i - 31, RoleId = 1, PermissionId = i });
            }
            #endregion
        }
    }
